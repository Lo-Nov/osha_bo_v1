...
@section('content')
    <section class="content">
        <header class="content__title">
            <h1>EXPIRES IN THE NEXT 30 DAYS</h1>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Food hygiene licenses that will expiry in the next 30 days</h4>
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-bordered">
                        ...
                        <tbody>
                        @foreach($getCertsExpiryIn30DaysHygiene->data as $key => $item)
                            <tr>
                                <td>{{  $item->idNo }}</td>
                                <td>{{  $item->certId }}</td>
