...
@section('content')
    <section class="content">
        <div class="content__inner">
            <h4 class="card-title">Approved Inspections</h4>
                    ...
                    <table id="data-table" class="table table-bordered">
                        ...
                        @foreach ($getInspections->data as $key=>$item)
                            <tr class="gradeX">
                                ...
                                <td>{{ $item->billNo }}</td>
                                <td>{{ number_format($item->costing,2) }}</td>
                                <td>{{ $item->telephone1 }}</td>
                                <td>{{ $item->physicalAdress }}</td>
                                <td>{{ $item->inspector }}</td>
                                <td>{{ $item->inspectionDate }}</td>
                                <td>
                                    <button class="btn btn-outline-info btnSelect"> <i class="zmdi zmdi-print"></i> Print</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
