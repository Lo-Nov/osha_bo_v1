...
@section('content')
    <section class="content">
        <div class="content__inner">
            <h4 class="card-title">Assign Inspection Results </h4>
                    ...
                    <table id="data-table" class="table table-bordered">
                        ...
                        @foreach ($getInspections->data as $key=>$item)
                            <tr class="gradeX">
                                ...
                                <td>
                                    <button class="btn btn-outline-success btnSelect" data-toggle="modal" data-target="#get-id"> <i class="zmdi zmdi-edit"></i> Results</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                ...
                <div class="modal-content">
                    ...
                    <form id="cform">
                            ...
                            <div class="form-row">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="">
                                            <label>Team Lead <strong class="text-danger">*</strong></label>
                                            <div class="select">
                                                <input type="text"  id="teamLead" name="teamLead" class="form-control" placeholder="Enter team lead name">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="">
                                            ...
                                            <textarea class="form-control alert alert-inverse" rows="5" id="description" name="description"
                                                      placeholder="Description" onclick="this.focus();this.select()"></textarea>
                                            <i class="form-group__bar d-none"></i>
                                        </div>
                                    ...
                                    <div class="col-md-12 ">
                                        <div class="">
                                            <label>Upload<strong class="text-danger">*</strong></label>
                                            <div class="select">
                        ...
                        <div class="modal-footer">
                            ...
                            <span type="submit" class="btn btn-outline-success btn-update-inspection">
