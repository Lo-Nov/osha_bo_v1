...
@section('content')
    <section class="content">
        <div class="content__inner">
            <h4 class="card-title">Approved Businesses</h4>
                    ...
                    <table id="data-table" class="table table-bordered">
                        ...
                        @foreach ($getInspections->data as $key=>$item)
                            <tr class="gradeX">
                                ...
                                <td>
                                    <button class="btn btn-outline-success btnSelect" data-toggle="modal" data-target="#get-id"> <i class="zmdi zmdi-check"></i> Action</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
                ...
                <div class="modal-content">
                    ...
                    <form id="cform">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-3">
                                        <div class="">
                                            ...
                                            <div class="">
                                                <textarea type="text" id="comments" name="comments" class="form-control" rows="5" placeholder="Enter comment...."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mt-3">
                        ...
                        <div class="modal-footer">
                            ...
                            <span type="submit" class="btn btn-outline-success btn-update-approve">
                        <i class="zmdi zmdi-save"></i>Generate Final Bill</span>
    ...
    <script type="text/javascript">
        ...
        $('.btn-update-approve').click(function(e){
            ...
            $.ajax({
                ...
                data: {approvedBy:approvedBy, status:status,comments:comments, inspectionCode:inspectionCode},
