            ...
            <div class="card">
                ...
                <div class="table-responsive" id="res-table">
                    <table id="data-table" class="table table-bordered">
                        ...
                        @foreach ($getBookings->data as $key=>$item)
                            <tr class="gradeX">
                                <td>{{ $item->id }} </td>
                                ...
                                <td>{{ $item->status }}</td>
                                <td>
                                    <button class="btn btn-outline-success btnSelect" data-toggle="modal" data-target="#get-id"> <i class="zmdi zmdi-check"></i> Confirm Booking</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form id="cform">
                        ...
                        <i class="zmdi zmdi-save"></i> Confirm</span>
