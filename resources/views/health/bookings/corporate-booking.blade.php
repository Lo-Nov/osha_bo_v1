...
@section('content')
    <section class="content">
        <div class="content__inner">
            <h4 class="card-title">Get Corporate Bookings</h4>
            ...
            <div class="card">
                ...
                <div class="table-responsive" id="res-table">
                    <table id="data-table" class="table table-bordered">
                        ...
                        @foreach ($getCorporateBookings->data as $key=>$item)
                            <tr class="gradeX">
                                <td>{{ $item->billNo }}</td>
                                <td>{{ $item->totalStaffPaidFor }} </td>
                                <td>{{ $item->customer }}</td>
                                <td>{{ $item->customerId }}</td>
                                <td>{{ $item->paymentsDate }}</td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
