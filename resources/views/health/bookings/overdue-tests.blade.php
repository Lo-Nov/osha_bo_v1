...
@section('content')
    <section class="content">
        <div class="content__inner">
            <h4 class="card-title">Over Due Tests</h4>
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row d-none">
                        ...
                        <div class="col-md-8">
                            <form action="{{ route('bookings') }}" method="post" novalidate>
                                @csrf
                ...
                <div class="table-responsive" id="res-table">
                    <table id="data-table" class="table table-bordered">
                        ...
                        @foreach ($getOverdueTestAlert->data as $key=>$item)
                            <tr class="gradeX">
                                <td class="d-none">{{ $item->id }} </td>
                                <td>{{ $item->businessID }} </td>
                                <td>{{ $item->suggestedDate }}</td>
                                <td>{{ $item->corporateComments }}</td>
                                <td>{{ $item->testingDate }}</td>
                                <td>{{ $item->testerComments }}</td>
                                <td class="d-none">{{ $item->status }}</td>
                                <td>{{ $item->confirmedBy }}</td>
                                <td>
                                    <button class="btn btn-info btnSelect" data-toggle="modal" data-target="#get-id"> <i class="zmdi zmdi-check"></i> Reassign </button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
