                ...
                <div class="service-form-container  d-flex flex-column-md animated col-12 p-0">
                    <div class="col-lg-7 service-form-img-container" id="health-img">
                        <div class="col-lg-8 col-md-12 position-relative p-5">
                            <h2 class="mb-4">Health Department</h2>
                        ...
                        <div class="col-12 p-0 the-transaction-form animated">
                            ...
                            <form class="transaction-form" action="{{ route('rnw-food-hygiene') }}" method="post">
                                ...
                                <div class="col-12 px-0 text-uppercase mt-5 pt-5">
                                    <button type="submit" class="btn btn-primary text-white w-100 p-4 center mx-0 btn-confirm-renew-food-hygiene"><span class="btn-text text-uppercase font-12">Renew License </span> <i data-feather="arrow-right" class="ml-2 float-right pull-right"></i></button>
                                </div>
                            </form>
                        </div>
